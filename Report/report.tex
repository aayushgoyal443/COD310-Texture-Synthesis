...
% 2) If we have any available data set, then it might be possible to train it as Deep learning based models. Tell you looked on the internet and were not able to find any data set. Mention about the papers and how they can be used.
